...
что вводимые числа по абсолютной величине не превышают 10^6. Нужно написать программу,
...
Примечание 1. Число xxx не превышает по абсолютной величине 10^6, если −10^6 ≤ x ≤10^6.
