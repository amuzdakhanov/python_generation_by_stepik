"""
На вход программе подается число nnn – количество собачьих лет. Напишите программу,
...
Примечание. В течение первых двух лет собачий год равен 10.510.510.5 человеческим годам.
